        ...
        <div class="flex items-center justify-center">
            <form method="GET" action="/gallery/" class="relative">
                ...
                <div class="relative flex items-center">
                    ...
                    <input type="text" name="search" placeholder="Find something..." class="bg-black bg-opacity-50 text-sm font-semibold placeholder-black focus:ring-transparent border-none !outline-none pl-7 text-center placeholder:text-violet-50 shadow-black shadow-md rounded-xl underline" value="{{ request('search') }}">
                </div>
            </form>
        </div>
