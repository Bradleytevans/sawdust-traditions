    ...
    <footer>
        <h2
            class="shadow-md shadow-black text-xl text-center  bg-gray-200 bg-opacity-80 w-1/4 rounded-tl-3xl rounded-br-3xl mx-auto mt-10 mb-10 p-4">
        ...
        <div class="flex mb-10 items-top justify-center text-gray-200">
            ...
            <div >
                <h3 class="underline mb-4 text-3xl bg-black bg-opacity-60 shadow-md shadow-black rounded-3xl p-4">
                    Contact Us
                </h3>
                <div class="bg-black bg-opacity-60 shadow-md shadow-black rounded-tl-3xl rounded-3xl px-8 py-6">
                    <p>
