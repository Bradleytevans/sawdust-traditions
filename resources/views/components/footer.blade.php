    ...
    <footer>
        ...
        <div class="flex mb-10 items-top justify-center text-gray-200">
            <img src="{{ asset('images/evansfam.png') }}" alt="" class="rounded-lg  shadow-black shadow-lg mx-5 h-28">
            <div>
            ...
            <img src="{{ asset('images/sawdust.png') }}" alt="" class="rounded-lg shadow-black shadow-lg mx-5 h-28">
        </div>
    </footer>